...
/////////////////////////////////////// vtk /////////////////////////
bool MeshMemory::readvtkHeader( FILE* fp, char* meshDescription ) {
    char str[ 100 ];
    fscanf( fp, "%[^\n]%*c", str );
    fscanf( fp, "%[^\n]%*c", meshDescription );  //
    fscanf( fp, "%[^\n]%*c", str );              // ASCII
...
bool MeshMemory::readvtkPoints( FILE* fp, int& npoint, double*& xyz ) {
    char str[ 100 ];
...
bool MeshMemory::readvtkCells( FILE* fp, int& ncell, int& cellsize, int*& cells ) {
    char str[ 100 ];
...
bool MeshMemory::readvtkCellTypes( FILE* fp, int ncell, int*& celltypes ) {
    char str[ 100 ];
...
bool MeshMemory::readvtkPointData( FILE* fp, int npoint, int& type, int& dim, double*& pointdata ) {
    char str[ 100 ];
...
bool MeshMemory::readvtkCellData( FILE* fp, int ncell, int& type, int& dim, double*& celldata ) {
    char str[ 100 ];
