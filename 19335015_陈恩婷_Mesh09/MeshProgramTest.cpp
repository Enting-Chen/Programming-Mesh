...
string YourName = "19335015.³Â¶÷æÃ.Mesh08";  //Change to your ID and name
...
TEST(Meshr, creation, 9)
{
	...
	double* celldata;
	int dimcell, ctype;
	s.readvtkCellData(fp, ncell, ctype, dimcell, (char*&)celldata);

	int dimpoint, ptype;
	double* pointdata;
	s.readvtkPointData(fp, npoint, ptype, dimpoint, (char*&)pointdata);
	...
	s4.readvtkCellData(fp, ncell, ctype, dimcell, (char*&)celldata);
	s4.readvtkPointData(fp, npoint, ptype, dimpoint, (char*&)pointdata);
	...
	s8.readvtkCellData(fp, ncell, ctype, dimcell, (char*&)celldata);
	...
	double* p8 = (double*)s8.dat_list[3]->data;

	//the following check should be modified according to your results
	CHECK_DOUBLES_EQUAL(p8[0], 0.0, 0.000001, 10);
	...
	CHECK_DOUBLES_EQUAL(p8[10], 0.0, 0.000001, 10);
	CHECK_DOUBLES_EQUAL(p8[12], 0.475528, 0.000001, 10);
	CHECK_DOUBLES_EQUAL(p8[14], 0.293893, 0.000001, 10);

	prog.program(200, 0, 3);

	CHECK_LONGS_EQUAL(s8.element_list_index, 2, 10);
	CHECK_LONGS_EQUAL(s8.map_list_index, 1, 10);
	CHECK_LONGS_EQUAL(s8.dat_list_index, 4, 10);

	p8 = (double*)s8.dat_list[3]->data;
	//the following check should be modified according to your results
	CHECK_DOUBLES_EQUAL(p8[0], 0, 0.0000001, 10);
	CHECK_DOUBLES_EQUAL(p8[2], 0, 0.0000001, 10);
	CHECK_DOUBLES_EQUAL(p8[4], 0, 0.0000001, 10);
	CHECK_DOUBLES_EQUAL(p8[6], 0, 0.0000001, 10);
	CHECK_DOUBLES_EQUAL(p8[8], 0, 0.0000001, 10);
	CHECK_DOUBLES_EQUAL(p8[10], 0, 0.0000001, 10);
	CHECK_DOUBLES_EQUAL(p8[12], 0, 0.0000001, 10);
	CHECK_DOUBLES_EQUAL(p8[14], 0, 0.0000001, 10);
